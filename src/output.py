...
def writing(t, xsat, ysat, zsat, vxsat, vysat, vzsat, xhost, yhost,zhost,\
            vxhost, vyhost, vzhost):
    ...
    for i in range(len(t)):
        ...
        yhost[i], zhost[i], vxhost[i]/conv_factor,vyhost[i]/conv_factor,\
        vzhost[i]/conv_factor))
