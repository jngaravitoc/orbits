...
t, xx , yy, zz, xx_mw, yy_mw, zz_mw, vx, vy, vz, vx_mw, vy_mw, \
ax, ay, az, ax_mw, ay_mw, az_mw = leapfrog(x_sat, y_sat, z_sat,\
vx_sat, vy_sat, vz_sat, M_host, M_bulge, M_disk, M_sat, Rvirhost)
